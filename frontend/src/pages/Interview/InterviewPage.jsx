...
import { useMockInterviews, useCreateMockInterview, useUpdateMockInterview } from '../../features/interview/hooks/useInterview';
...
export default function InterviewPage() {
  ...
  const saveMockInterview = useCreateMockInterview();
